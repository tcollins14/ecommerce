        	...
        	<div class="grid-x grid-padding-x">
        		<div class="small-12">
        			...
        			<div v-else>
        				...
        				<table class="hover unstriped">
        					...
        					<tbody>
        						<tr v-for="item in items">
        							<td class="medium-text-center"> <a :href="'/product/' + item.id">
        							...
        							<td class="text-center"> 
        								<button @click="removeItem(item.index)"> <i class="fa fa-times" aria-hidden="true"></i> </button> 
        							</td>
        						</tr>
        					</tbody>
        				</table>
                        ...
                        <div class="text-left">
                            <button type="submit" class="button primary float-left" @click="emptyCart()">
                                Empty Cart &nbsp; <i aria-hidden="true"></i>
                            </button>
                        </div>
