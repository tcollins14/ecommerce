...
<div class="add-product admin_shared">
    <div class="grid-x grid-padding-x">
            <div class="cell medium-11"> <h2>Add Inventory Item</h2> <hr />
            </div>
    </div>
    ...
    <div class="small-12 medium-11">
        <div class="grid-x grid-padding-x">
            ...
            <div class="input-group">
                <span class="input-group-label"> Product Image: 
                </span>
            ...
            <div class="small-12 cell">
                <label>Description:
                <textarea name="description" placeholder="Description"><?php echo e(\App\Classes\Request::old('post', 'description')); ?>
