...
<div class="products admin_shared">
    <div class="grid-x grid-padding-x">
            <div class="cell medium-11"> <h2>Manage Inventory Items</h2> <hr />
            </div>
    </div>
        ...
        <div class="small-12 medium-11 cell">
            <?php if(count($products)): ?>
                <table class="hover unstriped" data-form="deleteForm">
                    <thead> 
                    <tr> <th> Image </th> <th> Name </th> <th> Price </th> <th> Quantity </th> <th> Category </th> <th> Subcategory </th> <th> Date Created </th> <th width="70"> Action </th> </tr>
                    </thead>
                    <tbody>
